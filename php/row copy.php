...
for ($i=1; $i < 4; $i++) { 
    ...
    <td><input type='text' name='field' class='course'></td>
    <td><select name='field_grade' class='grade' oninput='getValues()'>
    ...
    <td><input type='number' value='3' name='field_credit' class='credits' oninput='getValues()'></td>
    <td class='remove-icon' title='Remove this row'>
