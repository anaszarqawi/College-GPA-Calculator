...
import UnlockIcon from '../assets/svg/unlock-icon';
...
const Card = (props) => {
  const { semesters, setSemesters, calculateGPA, handleCopyResults, defaultSemester, showMsg } = useCalc();
  ...
  const handleClickWithLockMode = () => {
    console.log('lockMode', lockMode);
    if (lockMode) {
      showMsg('warning', 'Unlock to edit!');
    }
  };
  ...
  return (
    <div
      ...
      <div className="card-calculator">
        ...
        <div className="card-body" onClick={handleClickWithLockMode}>
